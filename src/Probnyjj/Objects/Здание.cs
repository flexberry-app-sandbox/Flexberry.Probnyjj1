...
namespace IIS.Probnyjj
{
    ...
    public class Здание : ICSSoft.STORMNET.DataObject
    {
        ...
        private int fпоЭтажей;
        
        private IIS.Probnyjj.Город fГород;
        ...
        /// поЭтажей.
        /// </summary>
        // *** Start programmer edit section *** (Здание.поЭтажей CustomAttributes)

        // *** End programmer edit section *** (Здание.поЭтажей CustomAttributes)
        private int поЭтажей
        {
            get
            {
                // *** Start programmer edit section *** (Здание.поЭтажей Get start)

                // *** End programmer edit section *** (Здание.поЭтажей Get start)
                int result = this.fпоЭтажей;
                // *** Start programmer edit section *** (Здание.поЭтажей Get end)

                // *** End programmer edit section *** (Здание.поЭтажей Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Здание.поЭтажей Set start)

                // *** End programmer edit section *** (Здание.поЭтажей Set start)
                this.fпоЭтажей = value;
                // *** Start programmer edit section *** (Здание.поЭтажей Set end)

                // *** End programmer edit section *** (Здание.поЭтажей Set end)
            }
        }
        ...
        [PropertyStorage(new string[] {
                "Город"})]
        [NotNull()]
        public virtual IIS.Probnyjj.Город Город
        {
            get
            {
                ...
                IIS.Probnyjj.Город result = this.fГород;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗданиеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗданиеE", typeof(IIS.Probnyjj.Здание));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗданиеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗданиеL", typeof(IIS.Probnyjj.Здание));
                }
            }
        }
    }
